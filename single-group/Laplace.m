function P = Laplace(ro,lz,PAR,parT,parC,riio,emch,riih,lzoh)
%
%**	it computes the distensional Pressure (P) from Laplace
%	equilibrium equations for given:
%
%	- current outer radius (ro)
%	- axial stretch from h configuration (lz)
...
%
P = (stM*hM + stA*hA)/ri;		% predicted luminal Pressure
%
end