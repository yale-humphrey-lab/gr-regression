...
etaUm = Keta(4); etaUc = Keta(5); etaq  = Keta(6);	% etas
%
%** active parameters
%
...
%
phiM = [phieM phimM phicM*betaM];			% local mass fractions of media [e mt cz 2*cd]
phiA = [phieA phicA*betaA];					% local mass fractions of adventitia [e ct cz 2*cd]
%
